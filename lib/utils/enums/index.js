...
exports.LOG_MESSAGES = {
  ...
  SHOULD_NOT_DISPATCH_ACTIVATE: '%s: Activating has been turned off for experiment %s.',
  SHOULD_NOT_DISPATCH_TRACK: '%s: Tracking has been turned off for experiment %s.',
...
exports.NODE_CLIENT_VERSION = '1.0.1';
