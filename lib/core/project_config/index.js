...
module.exports = {
   ...
   */
  isExperimentRunningOrLaunched: function(projectConfig, experimentKey) {
  ...
  /**
   * Determine for given experiment if event should be dispatched or not
   */
  shouldDispatchEvent: function(projectConfig, experimentKey) {
    return module.exports.getExperimentStatus(projectConfig, experimentKey) === EXPERIMENT_RUNNING_STATUS;
  },
