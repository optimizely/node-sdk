...
describe('lib/core/project_config', function() {
  ...
  describe('projectConfig helper methods', function() {
    ...
    it('should return true if experiment status is set to Running or Launch in isExperimentRunningOrLaunched', function() {
      assert.isTrue(projectConfig.isExperimentRunningOrLaunched(configObjNewOptly, 'testExperiment'));

      assert.isTrue(projectConfig.isExperimentRunningOrLaunched(configObjNewOptly, 'testExperimentLaunched'));
    });

    it('should return true if experiment status is set to Running or Launch in isExperimentRunningOrLaunched', function() {
      assert.isFalse(projectConfig.isExperimentRunningOrLaunched(configObjNewOptly, 'testExperimentNotRunning'));
    });
