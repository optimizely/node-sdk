...
function getCommonEventParams(configObj, userId, attributes) {
  if (configObj.version === NEW_OPTIMIZELY_VERSION) {
    ...
    if (attributes) {
      var attributeParams = getAttributeParamsClassicOptimizely(configObj, attributes);
 ...
 * @param {Object} attributes Object representing user attributes and values which need to be recorded
 */
function getAttributeParamsClassicOptimizely(configObj, attributes) {
  var attributeParams = {};
 ...
 */
function getImpressionGoalParamsClassicOptimizely(configObj, experimentKey) {
 ...
 */
function getConversionGoalParamsClassicOptimizely(configObj, eventKey, eventValue) {
 ...
 */
function getExperimentParamsClassicOptimizely(configObj, experimentKey, variationId) {
 ...
 */
function getExperimentVariationParamsClassicOptimizely(configObj, variationIds, validExperimentIdsForGoal) {
 ...
 */
function getImpressionEventParamsNewOptimizely(configObj, experimentKey, variationId) {
 ...
 */
function getConversionEventParamsNewOptimizely(configObj, eventKey, eventValue, variationIds, validExperimentIdsForEvent) {
...
module.exports = {
  ...
  getImpressionEvent: function(options) {
    ...
    if (options.configObj.version === NEW_OPTIMIZELY_VERSION) {
      ...
      var impressionEventParams = getImpressionEventParamsNewOptimizely(options.configObj, options.experimentKey, options.variationId);
      ...
      var impressionGoalParams = getImpressionGoalParamsClassicOptimizely(options.configObj, options.experimentKey);
      var experimentParams = getExperimentParamsClassicOptimizely(options.configObj, options.experimentKey, options.variationId);
  ...
  getConversionEvent: function(options) {
    ...
    if (options.configObj.version === NEW_OPTIMIZELY_VERSION) {
      ...
      var conversionEventParams = getConversionEventParamsNewOptimizely(options.configObj, options.eventKey, options.eventValue, options.variationIds, options.validExperimentIdsForGoal);
      ...
      var conversionGoalParams = getConversionGoalParamsClassicOptimizely(options.configObj, options.eventKey, options.eventValue);
      var experimentVariationParams = getExperimentVariationParamsClassicOptimizely(options.configObj, options.variationIds, options.validExperimentIdsForGoal);
