...
module.exports = {
   ...
   */
  getImpressionEvent: function(configObj, experimentKey, variationId, userId, attributes) {
    var impressionEvent = {};

    impressionEvent.url = getUrl(configObj);

    var commonParams = getCommonParams(configObj, userId, attributes);
   ...
   */
  getConversionEvent: function(configObj, eventKey, userId, attributes, eventValue, variationIds, validExperimentIdsForGoal) {
    var conversionEvent = {};

    conversionEvent.url = getUrl(configObj);
