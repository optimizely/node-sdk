 ...
 * @param  {Array}  experimentsToBucketedVariationsMap Map of experiment ids to bucketed variation ids
...
function getConversionEventParams(configObj, eventKey, eventTags, experimentsToBucketedVariationsMap) {
  ...
  lodashForOwn(experimentsToBucketedVariationsMap, function(bucketedVariationId, experimentId) {
    if (bucketedVariationId) {
      var layerState = {
        ...
        decision: {
          isLayerHoldback: false,
          experimentId: experimentId,
          variationId: bucketedVariationId,
        },
...
module.exports = {
   ...
   * @param  {string} options.userId                          ID for user
   * @param  {Object} options.experimentsToBucketedVariations Map of experiment ids to bucketed variation ids
