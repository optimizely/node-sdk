 ...
 * @param  {Array}  experimentsToBucketedVariationsMap Map of experiments to bucketed variations
 * @return {Object}                                    Conversion event params
 */
function getConversionEventParams(configObj, eventKey, eventTags, experimentsToBucketedVariationsMap) {
  ...
  lodashForOwn(experimentsToBucketedVariationsMap, function(bucketedVariationKey, experimentKey) {
    var experimentId = projectConfig.getExperimentId(configObj, experimentKey);
    var variationId = projectConfig.getVariationIdFromExperimentAndVariationKey(configObj, experimentKey, bucketedVariationKey);
...
module.exports = {
   ...
   * @param  {string} options.userId                          ID for user
   * @param  {Object} options.experimentsToBucketedVariations Map of experiments to bucketed variation keys
  ...
  getConversionEvent: function(options) {
    ...
    var conversionEventParams = getConversionEventParams(options.configObj,
                                                         options.eventKey,
                                                         options.eventTags,
                                                         options.experimentsToBucketedVariations);
