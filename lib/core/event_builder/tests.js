...
describe('lib/core/event_builder', function() {
  describe('APIs', function() {
    ...
    describe('getConversionEvent', function() {
      ...
      it('should create proper params for getConversionEvent in New Optimizely with session ID', function() {
        var expectedParams = {
          url: 'https://logx.optimizely.com/log/event',
          httpVerb: 'POST',
          params: {
      ...
      it('should create proper params for getConversionEvent in New Optimizely with attributes and session ID', function() {
        var expectedParams = {
          url: 'https://logx.optimizely.com/log/event',
          httpVerb: 'POST',
          params: {
      ...
      it('should create proper params for getConversionEvent in New Optimizely with attributes and eventValue and session ID', function() {
        var expectedParams = {
          url: 'https://logx.optimizely.com/log/event',
          httpVerb: 'POST',
          params: {
      ...
      it('should create proper params for getConversionEvent in New Optimizely with deprecated eventValue', function() {
        var expectedParams = {
          url: 'https://logx.optimizely.com/log/event',
          httpVerb: 'POST',
          params: {
      ...
      it('should create proper params for getConversionEvent in New Optimizely with deprecated sessionId', function() {
        var expectedParams = {
          url: 'https://logx.optimizely.com/log/event',
          httpVerb: 'POST',
          params: {
