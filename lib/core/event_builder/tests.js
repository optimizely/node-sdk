...
describe('lib/core/event_builder', function() {
  describe('APIs', function() {
    ...
    describe('getImpressionEvent', function() {
      ...
      it('should not fill in userFeatures for getImpressionEvent when attribute is not in datafile', function() {
        var expectedParams = {
          url: 'https://p13nlog.dz.optimizely.com/log/decision',
          httpVerb: 'POST',
          params: {
    ...
    describe('getConversionEvent', function() {
      ...
      it('should not fill in userFeatures for getConversion when attribute is not in datafile', function() {
        var expectedParams = {
          url: 'https://p13nlog.dz.optimizely.com/log/event',
          httpVerb: 'POST',
          params: {
