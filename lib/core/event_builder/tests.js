...
describe('lib/core/event_builder', function() {
  describe('APIs', function() {
    ...
    describe('getConversionEvent', function() {
      ...
      it('should create proper params for getConversionEvent in New Optimizely with attributes and revenue and session ID', function() {
        var expectedParams = {
          url: 'https://logx.optimizely.com/log/event',
          httpVerb: 'POST',
          params: {
      ...
      it('should create proper params for getConversionEvent in New Optimizely with deprecated revenue', function() {
        var expectedParams = {
          url: 'https://logx.optimizely.com/log/event',
          httpVerb: 'POST',
          params: {
