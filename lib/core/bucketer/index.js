...
module.exports = {
  ...
  bucket: function(bucketerParams) {
    ...
    if (entityId === null) {
      ...
      var emptyTrafficAllocationRangeMessage = sprintf(LOG_MESSAGES.EMPTY_TRAFFIC_ALLOC_RANGE, MODULE_NAME);
        bucketerParams.logger.log(LOG_LEVEL.DEBUG, emptyTrafficAllocationRangeMessage);
      return null;
    } else {
