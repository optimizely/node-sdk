...
DecisionService.prototype.__getStoredVariation = function(experiment, userProfile) {
  if (!!userProfile && userProfile.experimentBucketMap.hasOwnProperty(experiment.id)) {
    var decision = userProfile.experimentBucketMap[experiment.id];
...
DecisionService.prototype.__saveUserProfile = function(userProfile, experiment, variation) {
  ...
  try {
    userProfile.experimentBucketMap[experiment.id] = {
