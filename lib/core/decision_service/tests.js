  ...
  describe('APIs', function() {
    ...
    describe('#getVariation', function() {
      ...
      it('should return the whitelisted variation if the user is whitelisted', function() {
        ...
        assert.strictEqual(mockLogger.log.args[0][1], sprintf(LOG_MESSAGES.USER_HAS_NO_FORCED_VARIATION, 'PROJECT_CONFIG', 'user2'));
      ...
      it('should return null if the user does not meet audience conditions', function() {
        ...
        assert.strictEqual(2, mockLogger.log.callCount);
        assert.strictEqual(mockLogger.log.args[0][1], sprintf(LOG_MESSAGES.USER_HAS_NO_FORCED_VARIATION, 'PROJECT_CONFIG', 'user3'));
      ...
      describe('when a user profile service is provided', function() {
        ...
        it('should return the previously bucketed variation', function() {
          ...
          sinon.assert.notCalled(bucketerStub);
          assert.strictEqual(mockLogger.log.args[0][1], sprintf(LOG_MESSAGES.USER_HAS_NO_FORCED_VARIATION, 'PROJECT_CONFIG', 'decision_service_user'));
