...
Optimizely.prototype.track = function(eventKey, userId, attributes, eventTags) {
  ...
  // The value passed as eventTags is not an object, so we consider it is a deprecated eventValue parameter.
  if (typeof eventTags !== 'undefined' && typeof eventTags !== 'object') {
    this.logger.log(LOG_LEVEL.WARNING, sprintf(LOG_MESSAGES.DEPRECATED_EVENT_VALUE, MODULE_NAME, 'track'))
    eventTags = {
      'eventValue': eventTags,
    };
  }
