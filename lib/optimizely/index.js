...
Optimizely.prototype.activate = function(experimentKey, userId, attributes) {
  try {
    ...
    var impressionEvent = eventBuilder.getImpressionEvent(this.configObj, experimentKey, variationId, userId, attributes);
...
Optimizely.prototype.track = function(eventKey, userId, attributes, eventValue) {
  try {
    ...
    var conversionEvent = eventBuilder.getConversionEvent(
      this.configObj,
      eventKey,
      userId,
      attributes,
