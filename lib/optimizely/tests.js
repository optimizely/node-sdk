...
describe('lib/optimizely', function() {
  ...
  describe('APIs', function() {
    ...
    describe('activate for Classic Optimizely', function() {
      ...
      describe('whitelisting', function() {
        beforeEach(function() {
          ...
          sinon.spy(Optimizely.prototype, '__checkIfExperimentIsRunningOrLaunched');
          sinon.spy(Optimizely.prototype, '__checkIfUserIsInAudience');
        });

        afterEach(function() {
          Optimizely.prototype.__validateInputs.restore();
          Optimizely.prototype.__checkIfExperimentIsRunningOrLaunched.restore();
        ...
        it('should return forced variation after experiment status check and before audience check', function() {
          ...
          sinon.assert.calledOnce(Optimizely.prototype.__checkIfExperimentIsRunningOrLaunched);
    ...
    describe('activate for Optimizely X', function() {
      ...
      it('should set session ID when passed in to activate call', function() {
        bucketStub.returns('111129');

        var bucketedVariation = newOptlyInstance.activate('testExperiment', 'testUser', null, 'testSessionId');
        assert.strictEqual(bucketedVariation, 'variation');
    ...
    describe('track in Optimizely X', function() {
      ...
      it('should set session ID when passed in to track call', function() {
        bucketStub.returns('111129');
        newOptlyInstance.track('testEvent', 'testUser', null, null, 'testSessionId');
    ...
    describe('__getValidExperimentInformationForEvent in Optimizely X', function() {
      ...
      describe('__checkIfExperimentIsRunningOrLaunched in Classic Optimizely', function() {
        it('should return true if experiment is running', function() {
          assert.isTrue(optlyInstance.__checkIfExperimentIsRunningOrLaunched('testExperiment', 'testUser'));
          sinon.assert.notCalled(createdLogger.log);
        });

        it('should return false when experiment is not running', function() {
          assert.isFalse(optlyInstance.__checkIfExperimentIsRunningOrLaunched('testExperimentNotRunning', 'testUser'));
          sinon.assert.calledOnce(createdLogger.log);
          var logMessage = createdLogger.log.args[0][1];
      ...
      describe('__checkIfExperimentIsRunningOrLaunched in Optimizely X', function() {
        it('should return true if experiment is running', function() {
          assert.isTrue(newOptlyInstance.__checkIfExperimentIsRunningOrLaunched('testExperiment', 'testUser'));
          sinon.assert.notCalled(createdLogger.log);
        });

        it('should return false when experiment is not running', function() {
          assert.isFalse(newOptlyInstance.__checkIfExperimentIsRunningOrLaunched('testExperimentNotRunning', 'testUser'));
          sinon.assert.calledOnce(createdLogger.log);
          var logMessage = createdLogger.log.args[0][1];
          assert.strictEqual(logMessage, sprintf(LOG_MESSAGES.EXPERIMENT_NOT_RUNNING, 'OPTIMIZELY', 'testExperimentNotRunning'));
        });
