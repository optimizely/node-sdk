...
describe('lib/optimizely', function() {
  ...
  describe('APIs', function() {
    ...
    describe('activate for New Optimizely', function() {
      var url = 'https://p13nlog.dz.optimizely.com/log/decision';

      it('should call bucketer and dispatchEvent with proper args and return variation key without attributes', function() {
        bucketStub.returns('111129');
