...
describe('lib/optimizely', function() {
  ...
  describe('APIs', function() {
    ...
    beforeEach(function() {
      ...
      sinon.stub(createdLogger, 'log');
      sinon.stub(returnsPromiseEventDispatcher, 'dispatchEvent');
    ...
    describe('#activate', function() {
      ...
      it('should execute a custom dispatchEvent\'s promise', function() {
        var instance = new Optimizely({
          clientEngine: 'node-sdk',
          datafile: testData.getTestProjectConfig(),
          errorHandler: errorHandler,
        ...
        sinon.assert.calledOnce(returnsPromiseEventDispatcher.dispatchEvent);
        console.log("___________________HEY_____________________")
        console.log(createdLogger.log)
        console.log("___________________HEY_____________________")

        // var eventDispatcherCall = stubEventDispatcher.dispatchEvent.args[0];
        // assert.deepEqual(eventDispatcherCall[0], expectedObj);
        // sinon.assert.calledOnce(createdLogger.log);

        // createdLogger.log.reset();
        //
        // var x = instance.activate('testExperiment', 'testUser');
        // console.log("HEYYYY LOOK", x);
        //
        // sinon.assert.calledOnce(createdLogger.log);
        // sinon.assert.called(eventDispatcher.dispatchEvent);
        // var logMessage = createdLogger.log.args[0][1];
