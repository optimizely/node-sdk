...
describe('lib/optimizely', function() {
  ...
  describe('APIs', function() {
    ...
    describe('__filterEmptyValues', function() {
      it('should filter out a null value attribute', function() {
        var attributes = {'test': null};
        var filteredAttributes = optlyInstance.__filterEmptyValues(attributes);
        assert.deepEqual(filteredAttributes, {});
      });

      it('should filter out an undefined value attribute', function() {
        var attributes = {'test': undefined};
        var filteredAttributes = optlyInstance.__filterEmptyValues(attributes);
        assert.deepEqual(filteredAttributes, {});
      });
      ...
      it('should filter out a null value eventTag', function() {
        ...
        var filteredEventTags = optlyInstance.__filterEmptyValues(eventTags);
        assert.deepEqual(filteredEventTags, {});
      });

      it('should filter out a undefined value eventTag', function() {
        var eventTags = {'test': undefined};
        var filteredEventTags = optlyInstance.__filterEmptyValues(eventTags);
        assert.deepEqual(filteredEventTags, {});
      });
