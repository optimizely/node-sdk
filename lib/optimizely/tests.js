...
describe('lib/optimizely', function() {
  ...
  describe('APIs', function() {
    ...
    describe('activate for Classic Optimizely', function() {
      ...
      describe('whitelisting', function() {
        beforeEach(function() {
          ...
          sinon.spy(Optimizely.prototype, '__checkIfExperimentIsRunning');
          sinon.spy(Optimizely.prototype, '__checkIfUserIsInAudience');
        });

        afterEach(function() {
          Optimizely.prototype.__validateInputs.restore();
          Optimizely.prototype.__checkIfExperimentIsRunning.restore();
        ...
        it('should return forced variation after experiment status check and before audience check', function() {
          ...
          sinon.assert.calledOnce(Optimizely.prototype.__checkIfExperimentIsRunning);
    ...
    describe('__getValidExperimentInformationForEvent in Optimizely X', function() {
      ...
      describe('__checkIfExperimentIsRunning in Classic Optimizely', function() {
        it('should return true if experiment is running', function() {
          assert.isTrue(optlyInstance.__checkIfExperimentIsRunning('testExperiment', 'testUser'));
          sinon.assert.notCalled(createdLogger.log);
        });

        it('should return false when experiment is not running', function() {
          assert.isFalse(optlyInstance.__checkIfExperimentIsRunning('testExperimentNotRunning', 'testUser'));
          sinon.assert.calledOnce(createdLogger.log);
          var logMessage = createdLogger.log.args[0][1];
      ...
      describe('__checkIfExperimentIsRunning in Optimizely X', function() {
        it('should return true if experiment is running', function() {
          assert.isTrue(newOptlyInstance.__checkIfExperimentIsRunning('testExperiment', 'testUser'));
          sinon.assert.notCalled(createdLogger.log);
        });

        it('should return false when experiment is not running', function() {
          assert.isFalse(newOptlyInstance.__checkIfExperimentIsRunning('testExperimentNotRunning', 'testUser'));
          sinon.assert.calledOnce(createdLogger.log);
          var logMessage = createdLogger.log.args[0][1];
          assert.strictEqual(logMessage, sprintf(LOG_MESSAGES.EXPERIMENT_NOT_RUNNING, 'OPTIMIZELY', 'testExperimentNotRunning'));
        });
