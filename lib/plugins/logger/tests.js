...
describe('lib/plugins/logger', function() {
  describe('APIs', function() {
    ...
    describe('setLogLevel', function() {
      ...
      it('should set the log level to the DEBUG when log level is not specified', function() {
        defaultLogger.setLogLevel();
        expect(defaultLogger.logLevel).to.equal(LOG_LEVEL.DEBUG);
      });

      it('should set the log level to the DEBUG when log level is not valid', function() {
